  ...
  const onSubmit: SubmitHandler<Inputs> = async (data) => {
   ...
   if(type === "create") {
      try {
        ...
        toast.error(
          error instanceof Error ? error.message : "An error occurred while creating the case study"
        );
      }
    }

    if(type === "edit" && caseStudy?.id) {
      try {
        ...
        toast.error(
          error instanceof Error ? error.message : "An error occurred while updating the case study"
        );
      }
    }
  }
        ...
        <Card className="space-y-5 p-5 sm:p-6">
          ...
          <Field label="Sub Title" htmlFor="subTitle">
            <input
              id="subTitle"
              {...register("subTitle")}
              placeholder="A short tagline for the case study"
              className={inputClass}
            />
          </Field>
        ...
        <Card className="space-y-5 p-5 sm:p-6">
          ...
          <Field label="Tags" htmlFor="tags">
            <input
              id="tags"
              {...register("tags")}
              placeholder="seo, performance, redesign"
              className={inputClass}
            />
